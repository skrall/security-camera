...
public class ImageCompare {
    ...
    public static void main(String[] args) {
        ...
        ImageCompare ic = new ImageCompare("src/test/resources/sample/person/a0002.jpg",
                                           "src/test/resources/sample/person/a0003.jpg");
    ...
    protected int getAverageBrightness(BufferedImage img) {
        ...
        //System.out.println(String.format("Total: %d BlocksX: %d BlocksY: %d FactorD: %d", total, r.getWidth(),
        //                                  r.getHeight(), factorD));
